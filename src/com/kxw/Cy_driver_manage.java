...
import com.kxw.Ty_carInfo.LoadAllInfo;
...
public class Cy_driver_manage extends ListActivity implements OnRefreshListener {
	private static String url_all_products = "http://120.27.26.219/kxw/android/cy_driver_carinfo.php"; 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv.setOnItemClickListener(new OnItemClickListener() { 
	        ...
	        public void onItemClick(AdapterView<?> parent, View view, int position, long id) { 
		        ...
		        Intent in = new Intent(getApplicationContext(),Cy_driver_manage_detail.class); 
	 ...
	 class LoadAllInfo extends AsyncTask<String, String, String> { 
		 ...
		 protected void onPreExecute() { 
		     super.onPreExecute(); 
		     pDialog = new ProgressDialog(Cy_driver_manage.this); 
		 ...
		 protected String doInBackground(String... args) { 
		     ...
		     try{ 
		         ...
		         if(success == 1) { 
		             jsinfo = json.getJSONArray("cy_carinfo"); 
					  ...
					  public void run() { 
						  ...
						  mAdapter = new SimpleAdapter( 
								...
								new int[] { R.id.txt_address,R.id.txt_load_address,R.id.txt_destination_address,R.id.txt_car_type,
										...
										R.id.txt_tel,R.id.txt_remark,R.id.txt_time,R.id.txt_fbnum}); 
