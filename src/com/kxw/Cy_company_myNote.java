...
import com.kxw.Cy_company_myNote.LoadAllInfo;
...
public class Cy_company_myNote extends ListActivity implements OnRefreshListener {
	...
	public void onCreate(Bundle savedInstanceState) { 
		...
		lv.setOnItemClickListener(new OnItemClickListener() { 
	        ...
	        public void onItemClick(AdapterView<?> parent, View view, int position, long id) { 
		        ...
		        String coe = ((TextView) view.findViewById(R.id.txt_coe)).getText().toString();
		        
		        Intent in = new Intent(getApplicationContext(),Cy_company_myNote2.class); 
	 ...
	 protected void onPreExecute() { 
	     super.onPreExecute(); 
	     pDialog = new ProgressDialog(Cy_company_myNote.this); 
		  ...
		  runOnUiThread(new Runnable() { 
			  public void run() { 
				  mAdapter = new SimpleAdapter( 
						Cy_company_myNote.this, infoList, 
					    R.layout.list_cy_mynote, new String[] { "hw_name", "address","ty_userid","fhr_name","fhr_tel","fh_address","fh_xxaddress",
					    		...
					    		"hw_weight","hw_vol","hw_bz","hw_remark","fbnum","carriage","ty_ispay","cy_isinsure","coe"}, 
						new int[] { R.id.txt_hwname, R.id.txt_address,R.id.txt_userid,R.id.txt_fhrname,R.id.txt_fhrtel,R.id.txt_fhaddress,
								...
								R.id.txt_hwremark,R.id.txt_fbnum,R.id.txt_carriage,R.id.txt_ty_ispay,R.id.txt_cy_isinsure,R.id.txt_coe}); 
