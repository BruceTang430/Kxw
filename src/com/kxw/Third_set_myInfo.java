...
public class Third_set_myInfo extends Activity {
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		ActivityCollector.getInstance().addActivity(this);
		 ...
		 String username=ty.get_third_username();
		 String tel=ty.get_third_tel();
		 String truename=ty.get_third_truename();
		 String idcard=ty.get_third_idcard();
		 String insure_address=ty.get_third_insure_address();
		 int userid=ty.get_third_userid();
