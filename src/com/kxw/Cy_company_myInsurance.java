...
public class Cy_company_myInsurance extends ListActivity implements OnRefreshListener {
	private static String url_all_products = "http://120.27.26.219/kxw/android/cy_company_myinsurance.php"; 
	...
	address,driver_name,driver_tel,driver_license,ispay;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		userid=id.get_cy_company_userid();
		cy_username=id.get_cy_company_username();
		...
		lv.setOnItemClickListener(new OnItemClickListener() { 
	        ...
	        public void onItemClick(AdapterView<?> parent, View view, int position, long id) { 
        		...
        		i.set_company_insurance_id(Integer.valueOf(insurance_id));
        		i.set_company_insurance_type(Integer.valueOf(insurance_type));
        		
		        Intent in = new Intent(getApplicationContext(),Cy_company_myInsurance_detail.class); 
	 ...
	 class LoadAllInfo extends AsyncTask<String, String, String> { 
		 ...
		 protected void onPreExecute() { 
		     super.onPreExecute(); 
		     pDialog = new ProgressDialog(Cy_company_myInsurance.this); 
		 ...
		 protected String doInBackground(String... args) { 
		     ...
		     try{ 
		         ...
		         if(success == 1) { 
		             jsinfo = json.getJSONArray("cy_myinsurance"); 
		             for(int i = 0; i < jsinfo.length(); i++) { 
		                 ...
		                 String fhorg=c.getString("fhorg");
		                 String shorg=c.getString("shorg");
		                 double time2 = c.getDouble("time");
...
//		                 if(time.equals("0")&&ispay.equals("0")){
//		                	 insurance_num="未付款";
//		                 }else if(insurance_num.equals("null")&&ispay.equals("1")){
//		                	 insurance_num="审核中";
//		                 }else if(insurance_num.equals("null")&&t==1){
//		                	 insurance_num="审核中";
//		                 }else if(insurance_num.equals("null")&&d>0){
//		                	 insurance_num="审核中";
//		                 }
				  ...
				  runOnUiThread(new Runnable() { 
					  public void run() { 
						  ...
						  mAdapter = new SimpleAdapter( 
								Cy_company_myInsurance.this, infoList, 
							    R.layout.list_cy_insurance, new String[] { "fbnum","insure_name","insured_tel","insured_address","insured_name",
							    		...
							    		"insurance_num","address","carnumber","delivertime","driver_name","driver_tel","driver_license",
							    		"time","ispay","premium","serial_num","fhorg","shorg","insurance_id","insurance_type"}, 
								new int[] { R.id.txt_fbnum,R.id.txt_insure_name,R.id.txt_insured_tel,R.id.txt_insured_address,
										...
										R.id.txt_time,R.id.txt_ispay,R.id.txt_premium,R.id.txt_serial_num,R.id.txt_fhorg,R.id.txt_shorg,
										R.id.txt_insurance_id,R.id.txt_insurance_type});
