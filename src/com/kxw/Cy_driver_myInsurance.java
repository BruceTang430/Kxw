...
public class Cy_driver_myInsurance extends ListActivity implements OnRefreshListener {
	private static String url_all_products = "http://120.27.26.219/kxw/android/cy_driver_myinsurance.php"; 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		userid=id.get_cy_driver_userid();
		cy_username=id.get_cy_driver_username();
		...
		lv.setOnItemClickListener(new OnItemClickListener() { 
	        ...
	        public void onItemClick(AdapterView<?> parent, View view, int position, long id) { 
        		...
        		i.set_driver_insurance_id(Integer.valueOf(insurance_id));
        		i.set_driver_insurance_type(Integer.valueOf(insurance_type));
        		
		        Intent in = new Intent(getApplicationContext(),Cy_driver_myInsurance_detail.class); 
	 ...
	 class LoadAllInfo extends AsyncTask<String, String, String> { 
		 ...
		 protected void onPreExecute() { 
		     super.onPreExecute(); 
		     pDialog = new ProgressDialog(Cy_driver_myInsurance.this); 
		 ...
		 protected String doInBackground(String... args) { 
			 List<NameValuePair> para = new ArrayList<NameValuePair>(); 
				...
				//para.add(new BasicNameValuePair("cyusername", cy_username)); 
				  ...
				  runOnUiThread(new Runnable() { 
					  public void run() { 
						  ...
						  mAdapter = new SimpleAdapter( 
								Cy_driver_myInsurance.this, infoList, 
							    R.layout.list_cy_insurance, new String[] { "fbnum","insure_name","insured_tel","insured_address","insured_name",
							    		...
							    		"insurance_num","address","carnumber","delivertime","driver_name","driver_tel","driver_license","ispay",
							    		"premium","serial_num","insurance_id","insurance_type"}, 
								new int[] { R.id.txt_fbnum,R.id.txt_insure_name,R.id.txt_insured_tel,R.id.txt_insured_address,
										...
										R.id.txt_ispay,R.id.txt_premium,R.id.txt_serial_num,R.id.txt_insurance_id,R.id.txt_insurance_type}); 
