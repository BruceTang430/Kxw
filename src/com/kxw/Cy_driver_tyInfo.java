...
import com.kxw.Cy_driver_tyInfo.LoadAllInfo;
...
public class Cy_driver_tyInfo extends ListActivity implements OnRefreshListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
	 ...
	 class LoadAllInfo extends AsyncTask<String, String, String> { 
		 ...
		 protected void onPreExecute() { 
		     super.onPreExecute(); 
		     pDialog = new ProgressDialog(Cy_driver_tyInfo.this); 
				  ...
				  runOnUiThread(new Runnable() { 
					  public void run() { 
						  ...
						  mAdapter = new SimpleAdapter( 
								Cy_driver_tyInfo.this, infoList, 
							    R.layout.list_tyinfo, new String[] { "hw_name","address","fhr_name","fhr_tel","fh_address","fh_xxaddress",
							    		...
							    		"hw_weight","hw_vol","hw_bz","hw_remark","time","fbnum","ty_userid","ty_tel","carriage_type","distance"}, 
								new int[] { R.id.txt_hwname,R.id.txt_address,R.id.txt_fhrname,R.id.txt_fhrtel,R.id.txt_fhaddress,
										...
										R.id.txt_hwremark,R.id.txt_time,R.id.txt_fbnum,R.id.txt_userid,R.id.txt_ty_tel,R.id.txt_carriage_type,R.id.txt_distance}); 
